...
<body class="bg-light">
        ...
        <section class="container">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center ">
                        ...
                        <h5 class="mb-0"><i class="fa-solid fa-users"></i> Lista de platos</h5>

                        <!-- Botón Registrar plato -->
                    <section class="container my-3 text-end">
                        <button type="button" class="btn btn-light text-dark" data-bs-toggle="modal" data-bs-target="#registroModalPlato">
                            <i class="fa-solid fa-user-plus"></i> Registrar nuevo plato
                        </button>
                    </section>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover mb-0">
                                ...
                                <tbody>
                                    <?php if (!empty($platos)): ?>
                                        <?php foreach ($platos as $u): ?>
                                            <tr>
                                                ...
                                                <td><img src="../../../<?php echo $u['Imagen']; ?>" 
                                                    alt="<?php echo $u['Nombre_producto']; ?>" 
                                                    width="80" height="80" 
                                                ...
                                                <td class="text-center">
                                                    <form method="POST" action="../../../Controller/PlatoController.php" class="d-inline">
                                                        ...
                                                        <button type="button" class="btn btn-dark btn-sm" 
                                                                data-bs-toggle="modal" 
                                                                data-bs-target="#editarModalplato<?= $u['Id_producto']; ?>">
                                                            <i class="fa-solid fa-pen"></i> Editar
                                                        </button>
                                                    </form>
                                                </td>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="6" class="text-center text-muted py-3">No hay platos registrados.</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-body">
            <form method="POST" action="../../../Controller/PlatoController.php" >
                <input type="hidden" name="id" value="<?= $u['Id_producto']; ?>">
